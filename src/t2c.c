...
FORCE_INLINE LLVMValueRef build_rs1_addr(LLVMValueRef start,
                                         ...
                                         rv_insn_t *ir)
{
    ...
    return LLVMBuildInBoundsGEP2(*builder, LLVMInt32Type(),
                                 LLVMGetParam(start, 0), rs1_offset, 1,
                                 "addr_rs1");
}

FORCE_INLINE LLVMValueRef build_rs2_addr(LLVMValueRef start,
                                         LLVMBuilderRef *builder,
                                         rv_insn_t *ir)
{
    ...
    return LLVMBuildInBoundsGEP2(*builder, LLVMInt32Type(),
                                 LLVMGetParam(start, 0), rs2_offset, 1,
                                 "addr_rs2");
}

FORCE_INLINE LLVMValueRef build_rd_addr(LLVMValueRef start,
                                        LLVMBuilderRef *builder,
                                        rv_insn_t *ir)
{
    ...
    return LLVMBuildInBoundsGEP2(*builder, LLVMInt32Type(),
                                 LLVMGetParam(start, 0), rd_offset, 1,
                                 "addr_rd");
}

FORCE_INLINE LLVMValueRef build_ra_addr(LLVMValueRef start,
                                        LLVMBuilderRef *builder,
                                        UNUSED rv_insn_t *ir)
{
    ...
    return LLVMBuildInBoundsGEP2(*builder, LLVMInt32Type(),
                                 LLVMGetParam(start, 0), ra_offset, 1,
                                 "addr_ra");
}

FORCE_INLINE LLVMValueRef build_sp_addr(LLVMValueRef start,
                                        LLVMBuilderRef *builder,
                                        UNUSED rv_insn_t *ir)
{
    ...
    return LLVMBuildInBoundsGEP2(*builder, LLVMInt32Type(),
                                 LLVMGetParam(start, 0), sp_offset, 1,
                                 "addr_sp");
}

FORCE_INLINE LLVMValueRef build_PC_addr(LLVMValueRef start,
                                        LLVMBuilderRef *builder,
                                        UNUSED rv_insn_t *ir)
{
    ...
    return LLVMBuildInBoundsGEP2(*builder, LLVMInt32Type(),
                                 LLVMGetParam(start, 0), PC_offset, 1,
                                 "addr_PC");
}

FORCE_INLINE void build_call_io_func(LLVMValueRef start,
                                     LLVMBuilderRef *builder,
                                     LLVMTypeRef *param_types,
                                     int offset)
{
    LLVMValueRef func_offset[1] = {LLVMConstInt(LLVMInt32Type(), offset, true)};
    ...
    LLVMValueRef io_param[1] = {LLVMGetParam(start, 0)};
...
void t2_compile(block_t *block, uint64_t mem_base)
{
    ...
    block->func = (void *) LLVMGetPointerToGlobal(engine, start);
    block->hot2 = true;
}
